...
<body>
	...
	<div align="center">
		...
		<table width="1200px">
			<tr>
				<td>내용: <input type="text" id="subject" name="subject"
					style="width: 500px;" placeholder="내용" value="${boardView.subject}" />
					작성자: <input type="text" id="writer" name="writer"
					style="width: 170px;" maxlength="10" placeholder="작성자"
					value="${boardView.writer}" /> 비밀번호: <input type="password"
					id="password" name="password" style="width: 170px;" maxlength="10"
					placeholder="패스워드" />
					<button id="save" name="save">저장</button>
					<button id="list" onclick="history.back();">취소</button>
				</td>
			</tr>
			<!--
			<tr>
